...
!!!!!! root_password_for_linode = "ef3a2d7938c1fd461f70" !!!!!


##take the ssh command and run it in linux bash (could be ubuntu on windows)
...
## with command:
hostnamect set-hostname uRnEwSeRvEr
...
## logout of your session with the linux server
...
## it'll prompt you for a passcode, do this if you'd like it more secure, but it's not neccesary
...
###  side note about linux commands:
